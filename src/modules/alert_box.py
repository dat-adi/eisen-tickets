...
class Example(object):
    ...
    def show(self):
        ...
        tk.Label(master=self.root, text="You will be deleting a ticket, do you wish to continue?").pack()
        true_button = tk.Button(self.root, text="Continue",
                                command=lambda: self.finish(True))
        false_button = tk.Button(self.root, text="Cancel",
